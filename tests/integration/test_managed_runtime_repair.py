...
class ManagedRuntimeRepairTests(CliTestCase):
    def test_repair_runtime_setup_blocker_does_not_edit_artifacts(self) -> None:
        ...
        before = (self.project / ".verifysignal" / "use-cases" / "profile-view-unauth.yaml").read_text(encoding="utf-8")
        ...
        after = (self.project / ".verifysignal" / "use-cases" / "profile-view-unauth.yaml").read_text(encoding="utf-8")
        assert after == before
