...
class WorkflowCliContractTests(CliTestCase):
    def test_workflow_info_json_contract(self) -> None:
        ...
        self.assertEqual(payload["schemaVersion"], "proofsignal-spec-workflow-info/v1")
        self.assertEqual(payload["nativeCommands"]["understand"], "/proofsignal-understand")
    ...
    def test_workflow_run_status_and_resume_contract(self) -> None:
        ...
        self.assertEqual(code, 0, err)
        payload = json.loads(out)
        self.assertEqual(payload["schemaVersion"], "proofsignal-spec-workflow-run/v1")
        self.assertEqual(payload["nextCommand"], "/proofsignal-understand login")
