---
name: "proofsignal-spec-validate"
description: "Validate ProofSignal artifacts."
---

Run `proofsignal-spec validate <alias> --runtime-readiness` and report Core
...
Use shared CLI JSON and `.proofsignal/` workspace state as the only source of
