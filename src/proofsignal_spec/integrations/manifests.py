...
from proofsignal_spec.workspace.repository import load_document, now_iso, save_document
...
def load_all_states(project: Path) -> dict[str, Any]:
    return load_document(layout.integration_state_path(project), default={"schemaVersion": "proofsignal-spec-integrations/v1", "integrations": {}})
