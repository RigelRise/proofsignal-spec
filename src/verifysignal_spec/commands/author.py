...
from verifysignal_spec.workspace.product_context import append_validation_goal
from verifysignal_spec.workspace.repository import create_default_use_case, save_use_case
...
def run(project: Path, alias: str, description: str, run_request: str | None = None, skills: list[str] | None = None) -> dict[str, Any]:
    ...
    return {
        ...
        "recordPath": f".verifysignal/use-cases/{record.alias}.yaml",
